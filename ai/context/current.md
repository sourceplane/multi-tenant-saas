...
The verifier picks up at Phase 5 (re-inspect wrangler binding +
substitution mechanism), then proceeds through Phases 6–10 in full per
`ai/tasks/task-0095-verifier.md`: merge, post-merge main-CI inspection,
live duplicate-POST replay evidence on stage covering cases (a)–(g),
