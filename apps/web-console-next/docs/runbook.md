...
Probe the console origin recorded in [`ai/context/deployment.md`](../../../ai/context/deployment.md), then probe the edge `/health` too — a green console does not imply a healthy API, because the console is static assets and survives an edge outage visually.
