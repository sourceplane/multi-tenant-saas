...
Authorization decisions. Every permission question in the product resolves here, against one engine, so a permission cannot mean one thing in the API and another in the console.
