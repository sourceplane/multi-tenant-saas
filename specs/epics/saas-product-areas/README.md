...
| **P5** | Integration marketplace primitives | 🗓️ Planned | P2 ideally, B5, B2 | Per-org install of third-party integrations via OAuth + a manifest; each integration a manifested resource (uses P2). |
