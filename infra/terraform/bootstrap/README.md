...
| Profile   | Role                                                                         |
| --------- | ---------------------------------------------------------------------------- |
| plan-only | `arn:aws:iam::306024784101:role/<env>-github-sourceplane-multi-tenant-saas-plan` |
| apply     | `arn:aws:iam::306024784101:role/<env>-github-sourceplane-multi-tenant-saas-production-deploy` |
